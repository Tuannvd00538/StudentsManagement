...
namespace Students_Management
{
    class Program
    {
        ...
        static void Seeder()
        {
            students.Add(new Student("Ngo Van Tuan", "26/11/1999", "TuanExpress", "T1708E", "yes", 0987773751));
            students.Add(new Student("Phan Van Hoang Hung", "26/11/1999", "TuanExpress", "T1708E", "yes", 0987773751));
        }
